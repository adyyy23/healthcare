...
if (isset($_POST['add_doctor'])) {
    try {
        ...
        $stmt->execute([$userId, $_POST['license_number']]);
...
$query .= " ORDER BY " . 
    ($sort === 'name' ? 'u.name' : 
    ($sort === 'email' ? 'u.email' : 'd.license_number')) . " " . $order;
...
<head>
    ...
    <title>Manage Doctors - HealthCare Portal</title>
    ...
    <div class="main-content">
                ...
                <form method="GET" class="row g-3">
                    ...
                    <div class="col-md-3">
                        <select class="form-select" name="sort">
                            ...
                            <option value="license" <?php echo $sort === 'license' ? 'selected' : ''; ?>>Sort by License</option>
                        </select>
                    </div>
                    <div class="col-md-3">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-primary"><?php echo count($doctors); ?> Doctors</span>
            </div>
            <div class="card-body">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <a href="?search=<?php echo urlencode($search); ?>&sort=license&order=<?php echo $sort === 'license' && $order === 'asc' ? 'desc' : 'asc'; ?>" 
                                       class="sort-link">
                                        License Number
                                        <?php if ($sort === 'license'): ?>
                                            <i class="bi bi-arrow-<?php echo $order === 'asc' ? 'up' : 'down'; ?>"></i>
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-primary" 
                                                ...
                                                data-bs-target="#viewDoctorModal<?php echo $doctor['id']; ?>">
                                            <i class="bi bi-eye"></i> View
                                        </button>
                                        <button type="button" class="btn btn-sm btn-danger" 
                                                data-bs-toggle="modal" 
                                                data-bs-target="#deleteDoctorModal<?php echo $doctor['id']; ?>">
                            ...
                            <!-- View Doctor Modal -->
                            <div class="modal fade" id="viewDoctorModal<?php echo $doctor['id']; ?>" tabindex="-1">
                            ...
                            <!-- Delete Doctor Modal -->
                            <div class="modal fade" id="deleteDoctorModal<?php echo $doctor['id']; ?>" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
